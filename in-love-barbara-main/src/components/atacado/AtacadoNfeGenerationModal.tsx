...
// Importações temporariamente comentadas para debug
// import { 
//   NFE_API_PROVIDERS, 
//   NFE_ENVIRONMENTS, 
//   EMPRESA_NFE_CONFIG,
...
interface AtacadoNfeGenerationModalProps {
  isOpen: boolean;
  onClose: () => void;
  sale: Sale | null;
}
...
export function AtacadoNfeGenerationModal({ isOpen, onClose, sale }: AtacadoNfeGenerationModalProps) {
...
<nfeProc versao="4.00" xmlns="http://www.portalfiscal.inf.br/nfe">
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="w-[95vw] sm:w-auto max-w-[1024px] sm:max-w-[600px] md:max-w-[800px] lg:max-w-[1024px] max-h-[90vh] overflow-y-auto p-4 sm:p-6 atacado-nfe-generation-modal">
        <DialogHeader>
